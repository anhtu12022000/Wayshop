            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form class="col-lg-12 row" id="myForm" action="{{ route('addrole') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label>Role</label>
                                    <input class="form-control" name="name" value="{{old('name')}}" placeholder="Please Enter Role" class="@error('name') is-invalid @enderror" />
                                    @error('name')
                            ...
                            <div class="col-lg-12 text-center">
                                ...
                                <a href="{{ url('admin/role/') }}" class="btn btn-danger">Hủy</a>
                            </div>
                        </form>
                    </div>
                    <!-- /.card -->
