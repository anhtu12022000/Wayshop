            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form class="col-lg-12 row" id="myForm" action="{{ url('admin/post/edit-post/'.$data->id) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="col-lg-8 row">
                                <div class="col-lg-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="description" placeholder="Description" id="" cols="30" rows="10" class="form-control @error('description') is-invalid @enderror">{{ $data->description }}</textarea>
                                        @error('description')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="form-group preview-img mt-3 text-center">
                                            <img width="200" height="200" src="{{ asset('/front_assets/img/post/'.$data->image) }}" class="preview-image img-fluid" alt="Ảnh đại diện sản phẩm">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label>Content</label>
                                        <textarea class="textarea @error('body') is-invalid @enderror" name="body" placeholder="Place some text here" >{{ $data->body }}</textarea>
                                        @error('body')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
