            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">DataTable with comment product</h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        @if (session('success'))
                                ...
                                @foreach ($data as $value)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <form method="POST" action="{{ url('admin/products/del-comment/'.$value['id']) }}" onsubmit="return confirm('Are you sure delete comment: {{ $value['author'] }}')">
                                                @method('DELETE')
                                                @csrf
