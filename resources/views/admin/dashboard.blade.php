...
<head>
      ...
      <link rel="shortcut icon" href="{{ asset('admin_/dist/img/ico/favicon.png') }}') }}" type="image/x-icon">
      <!-- Start Global Mandatory Style
         =====================================================================-->
      <!-- jquery-ui -->
      <link href="{{ asset('admin_/plugins/jquery-ui-1.12.1/jquery-ui.min.css') }}" rel="stylesheet" type="text/css"/>
      <!-- Bootstrap -->
      <link href="{{ asset('admin_/bootstrap/css/bootstrap.min.css') }}" rel="stylesheet" type="text/css"/>
      <!-- Bootstrap rtl -->
      <!--<link href="{{ asset('admin_/bootstrap-rtl/bootstrap-rtl.min.css') }}" rel="stylesheet" type="text/css') }}"/>-->
      <!-- Lobipanel css') }} -->
      <link href="{{ asset('admin_/plugins/lobipanel/lobipanel.min.css') }}" rel="stylesheet" type="text/css"/>
      <!-- Pace css') }} -->
      <link href="{{ asset('admin_/plugins/pace/flash.css') }}" rel="stylesheet" type="text/css"/>
      <!-- Font Awesome -->
      <link href="{{ asset('admin_/font-awesome/css/font-awesome.min.css') }}" rel="stylesheet" type="text/css"/>
      <!-- Pe-icon -->
      <link href="{{ asset('admin_/pe-icon-7-stroke/css/pe-icon-7-stroke.css') }}" rel="stylesheet" type="text/css"/>
      <!-- Themify icons -->
      <link href="{{ asset('admin_/themify-icons/themify-icons.css') }}" rel="stylesheet" type="text/css"/>
      <!-- End Global Mandatory Style
         =====================================================================-->
      <!-- Start page Label Plugins 
         =====================================================================-->
      <!-- Emojionearea -->
      <link href="{{ asset('admin_/plugins/emojionearea/emojionearea.min.css') }}" rel="stylesheet" type="text/css"/>
      <!-- Monthly css') }} -->
      <link href="{{ asset('admin_/plugins/monthly/monthly.css') }}" rel="stylesheet" type="text/css"/>
      <!-- End page Label Plugins 
         =====================================================================-->
      <!-- Start Theme Layout Style
         =====================================================================-->
      <!-- Theme style -->
      <link href="{{ asset('admin_/dist/css/stylecrm.css') }}" rel="stylesheet" type="text/css"/>
      <!-- Theme style rtl -->
      <!--<link href="admin_/dist/css/stylecrm-rtl.css" rel="stylesheet" type="text/css') }}"/>-->
   ...
   <body class="hold-transition sidebar-mini">
      ...
      <div class="wrapper">
         <header class="main-header">
            <a href="index.html" class="logo">
               ...
               <img src="{{ asset('admin_/dist/img/mini-logo.png') }}" alt="">
               </span>
               <span class="logo-lg">
               <img src="{{ asset('admin_/dist/img/logo.png') }}" alt="">
               </span>
            </a>
            <!-- Header Navbar -->
             ...
             <div class="navbar-custom-menu">
                  <ul class="nav navbar-nav">
                              ...
                              <ul class="menu">
                                 <li >
                                    ...
                                    <a href="#" class="border-gray">
                                       <div class="pull-left">
                                          <img src="{{ asset('admin_/dist/img/basketball-jersey.png') }}" class="img-thumbnail" alt="User Image">
                                       </div>
                                       <h4>polo shirt</h4>
                                 ...
                                 <li>
                                    <a href="#" class="border-gray">
                                       <div class="pull-left">
                                          <img src="{{ asset('admin_/dist/img/shirt.png') }}" class="img-thumbnail" alt="User Image">
                                       </div>
                                       <h4>Kits</h4>
                                 ...
                                 <li>
                                    <a href="#" class="border-gray">
                                       <div class="pull-left">
                                          <img src="{{ asset('admin_/dist/img/football.png') }}" class="img-thumbnail" alt="User Image">
                                       </div>
                                       <h4>Football</h4>
                                 ...
                                 <li class="nav-list">
                                    <a href="#" class="border-gray">
                                       <div class="pull-left">
                                          <img src="{{ asset('admin_/dist/img/shoe.png') }}" class="img-thumbnail" alt="User Image">
                                       </div>
                                       <h4>Sports sheos</h4>
                           ...
                           <li>
                              <ul class="menu">
                                 <li>
                                    ...
                                    <a href="#" class="border-gray">
                                       <div class="pull-left">
                                          <img src="{{ asset('admin_/dist/img/avatar.png') }}" class="img-circle" alt="User Image">
                                       </div>
                                       <h4>Ronaldo</h4>
                                 ...
                                 <li>
                                    <a href="#" class="border-gray">
                                       <div class="pull-left">
                                          <img src="{{ asset('admin_/dist/img/avatar2.png') }}" class="img-circle" alt="User Image">
                                       </div>
                                       <h4>Leo messi</h4>
                                 ...
                                 <li>
                                    <a href="#" class="border-gray">
                                       <div class="pull-left" >
                                          <img src="{{ asset('admin_/dist/img/avatar3.png') }}" class="img-circle" alt="User Image">
                                       </div>
                                       <h4>Modric</h4>
                                 ...
                                 <li>
                                    <a href="#" class="border-gray">
                                       <div class="pull-left">
                                          <img src="{{ asset('admin_/dist/img/avatar4.png') }}" class="img-circle" alt="User Image">
                                       </div>
                                       <h4>Salman</h4>
                                 ...
                                 <li>
                                    <a href="#" class="border-gray">
                                       <div class="pull-left">
                                          <img src="{{ asset('admin_/dist/img/avatar5.png') }}" class="img-circle" alt="User Image">
                                       </div>
                                       <h4>Sergio Ramos</h4>
                     ...
                     <li class="dropdown dropdown-user">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <img src="{{ asset('admin_/dist/img/avatar5.png') }}" class="img-circle" width="45" height="45" alt="user"></a>
                        <ul class="dropdown-menu" >
                           <li>
                              <a href="profile.html">
      ...
      <!-- Start Core Plugins
         =====================================================================-->
      <!-- jQuery -->
      <script src="{{ asset('admin_/plugins/jQuery/jquery-1.12.4.min.js') }}" type="text/javascript"></script>
      <!-- jquery-ui --> 
      <script src="{{ asset('admin_/plugins/jquery-ui-1.12.1/jquery-ui.min.js') }}" type="text/javascript"></script>
      <!-- Bootstrap -->
      <script src="{{ asset('admin_/bootstrap/js/bootstrap.min.js') }}" type="text/javascript"></script>
      <!-- lobipanel -->
      <script src="{{ asset('admin_/plugins/lobipanel/lobipanel.min.js') }}" type="text/javascript"></script>
      <!-- Pace js') }} -->
      <script src="{{ asset('admin_/plugins/pace/pace.min.js') }}" type="text/javascript"></script>
      <!-- SlimScroll -->
      <script src="{{ asset('admin_/plugins/slimScroll/jquery.slimscroll.min.js') }}" type="text/javascript">    </script>
      <!-- FastClick -->
      <script src="{{ asset('admin_/plugins/fastclick/fastclick.min.js') }}" type="text/javascript"></script>
      <!-- CRMadmin frame -->
      <script src="{{ asset('admin_/dist/js/custom.js') }}" type="text/javascript"></script>
      <!-- End Core Plugins
         =====================================================================-->
      <!-- Start Page Lavel Plugins
         =====================================================================-->
      <!-- Chartjs') }} JavaScript -->
      <script src="{{ asset('admin_/plugins/chartjs/Chart.min.js') }}" type="text/javascript"></script>
      <!-- Counter js') }} -->
      <script src="{{ asset('admin_/plugins/counterup/waypoints.js') }}" type="text/javascript"></script>
      <script src="{{ asset('admin_/plugins/counterup/jquery.counterup.min.js') }}" type="text/javascript"></script>
      <!-- Monthly js') }} -->
      <script src="{{ asset('admin_/plugins/monthly/monthly.js') }}" type="text/javascript"></script>
      <!-- End Page Lavel Plugins
         =====================================================================-->
      <!-- Start Theme label Script
         =====================================================================-->
      <!-- Dashboard js') }} -->
      <script src="{{ asset('admin_/dist/js/dashboard.js') }}" type="text/javascript"></script>
