            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="card card-primary">
                        ...
                        <h3 class="card-title">Form edit Cate</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form class="col-lg-12 row" id="myForm" action="{{ url('admin/cate/edit-cate/'.$data->id) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="col-lg-12">
