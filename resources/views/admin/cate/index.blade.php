            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">DataTable with default features</h3><a href="{{ url('admin/cate/add-cate') }}" class="btn btn-info float-right">Thêm</a>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        @if (session('success'))
                                ...
                                @foreach ($data as $value)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a href="{{ url('admin/cate/del-cate',$value['id']) }}" onclick="return confirm('Bạn có muốn xóa không?');" class="btn btn-sm btn-danger"><i class="fas fa-trash-alt"></i></a>
                                        </td>
                                    </tr>
                                    @php $i++; @endphp
                                @endforeach
